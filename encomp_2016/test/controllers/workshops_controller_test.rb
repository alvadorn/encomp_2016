...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, end_time: @workshop.end_time, name: @workshop.name, start_time: @workshop.start_time }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { description: @workshop.description, end_time: @workshop.end_time, name: @workshop.name, start_time: @workshop.start_time }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
